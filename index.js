...
// تعيين حد أقصى لحجم الملف (25 ميجابايت لضمان قبول ملفات الفيديو MP4 ضمن حدود MongoDB)
const upload = multer({  
  storage,
...
const SettingsSchema = new mongoose.Schema({
  ...
  // 🎨 الحقول الأربعة الجديدة المضافة للألوان المتقدمة
...
// دالة مساعدة لتحويل الملف المخزن في الذاكرة إلى Base64 String مع حماية الحجم (25 ميجابايت)
...
app.post('/api/settings', upload.fields([
  ...
  try {
    ...
    // 🎨 حفظ ألوان المظهر المتقدمة الجديدة في قاعدة البيانات
