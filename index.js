...
// Schema الخاص بـ إعدادات الثيمة والمظهر والوصف الفرعي (بدون حقول الاشتراكات المحذوفة)
...
app.post('/api/restaurant-login', (req, res) => {
  ...
  // بيانات الدخول الخاصة بصاحب المطعم (مفصولة عن المشرف)
  const REST_USER = "restaurant";
  const REST_PASS = "rest123"; // يمكنك تغييرها كما تشاء
...
// حفظ إعدادات الثيمة والشعار/الغلاف/خلفية الرئيسية/فيديو الرئيسية
