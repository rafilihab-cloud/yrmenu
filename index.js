...
const SettingsSchema = new mongoose.Schema({
  ...
  restaurantTagline: { type: String, default: '' }, // دعم حقل الوصف الفرعي
  ...
  //  تمت إضافة حقول حالة الاشتراك وتاريخ الانتهاء هنا
...
app.post('/api/settings', upload.fields([
  ...
  try {
    const { 
      restaurantName, 
      restaurantTagline, // استقبال الوصف الفرعي
      tagline,           // دعم التسمية البديلة للوصف الفرعي
      primaryColor, 
      secondaryColor, 
      cardBgColor, 
      textColor,
      subscriptionStatus, //  استقبال الحالة
      expiryDate          //  استقبال تاريخ الانتهاء
    } = req.body;
    ...
    // حفظ الوصف الفرعي سواء جاء من حقل restaurantTagline أو tagline
    ...
    //  حفظ حالة الاشتراك وتاريخ الانتهاء في قاعدة البيانات
